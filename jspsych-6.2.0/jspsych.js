...
window.jsPsych = (function () {
  ...
  core.webaudio_context =
    typeof window !== 'undefined' && typeof window.AudioContext !== 'undefined' ? new AudioContext() : null;
    ...
    var _construct = (function () {
      ...
      if (typeof parameters.timeline !== 'undefined' || typeof jsPsych.plugins[trial_type] == 'function') {
        ...
        timeline_parameters = {
          ...
          timeline_variables:
            typeof parameters.timeline_variables == 'undefined' ? [{}] : parameters.timeline_variables,
        };
      ...
      // if there is no timeline parameter, then this node is a trial node
        ...
        if (typeof trial_type == 'undefined') {
          ...
          trial_type.toString().replace(/\s/g, '') != 'function(){returntimeline.timelineVariable(varname);}'
        ) {
  ...
  function evaluateTimelineVariables(trial) {
    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      if (
        ...
        trial[keys[i]].toString().replace(/\s/g, '') == 'function(){returntimeline.timelineVariable(varname);}'
      ) {
...
jsPsych.data = (function () {
  ...
  module.createInteractionListeners = function () {
    ...
    function fullscreenchange() {
      var type =
        document.isFullScreen || document.webkitIsFullScreen || document.mozIsFullScreen || document.fullscreenElement
          ? 'fullscreenenter'
          : 'fullscreenexit';
      var data = {
        event: type,
