    ...
    on_finish: function () {
        if (PRMS.count_block >= PRMS.n_blocks) {
            window.location.assign(
                "https://uni-tuebingen.sona-systems.com/webstudy_credit.aspx?experiment_id=770&credit_token=627d4c4c5e3a4745b518d5e42ab698ab&survey_code=" +
...
const WELCOME_INSTRUCTIONS = {
    ...
    stimulus: generate_formatted_html({
        text: `Willkommen zu unserem Experiment:<br><br>
               ...
               henri.schwaerzler@student.uni-tuebingen.de<br><br>
