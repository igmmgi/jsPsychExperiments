// Version 3 for pilot SFB ironic errors series of experiments
    ...
    on_finish: function () {
        if (PRMS.count_block >= PRMS.n_blocks) {
            window.location.assign(
                "https://uni-tuebingen.sona-systems.com/webstudy_credit.aspx?experiment_id=771&credit_token=0312138e416a47ec82b40946318ead82&survey_code=" +
...
const WELCOME_INSTRUCTIONS = {
    ...
    stimulus: generate_formatted_html({
        text: `Willkommen zu unserem Experiment:<br><br>
               ...
               akanksha.kamath@student.uni-tuebingen.de<br><br>
