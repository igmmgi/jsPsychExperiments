// Version 2.2 for pilot SFB ironic errors series of experiments
...
// 2) Medium noise
// 3) High noise
// (Global noise type is set in PRMS)
//
...
const PRMS = {
    n_trials: 3, // number of trials per block (must be multiple of 3)
    ...
    noise_type: "reversal", // option: "reversal" or "gaussian"
    noise_reversal_prob: { low: 0.10, med: 0.20, high: 0.30 }, // probability of reversing mouse movement
    noise_gaussian_sd: { low: 2, med: 4, high: 6 }, // SD of gaussian noise added to movement
    ball_diameter: 20,
...
const TRIAL = {
    ...
    on_start: function (trial) {
        ...
        BALL.noise_type = PRMS.noise_type;
