...
const PRMS = {
    ...
    fbDelay: 750, // delay before feedback in delayed blocks
    fbTxtSizeBlock: 30,
...
const PRE_FEEDBACK_DELAY = {
    ...
    on_start: function (trial) {
        ...
        trial.trial_duration = (block_type === "delayed") ? PRMS.fbDelay : 0;
    }
};
...
const TRIAL_FEEDBACK = {
    ...
    on_start: function (trial) {
        ...
        trial.stimulus = generate_formatted_html({
            text: `${PRMS.fbText[dat.corr_code - 1]}`,
            align: "center",
            fontsize: 30,
            width: "1200px",
            lineheight: 1.5,
...
const ITI = {
    ...
    on_start: function (trial) {
        let block_type = BLOCK_CONDITIONS[PRMS.cBlk - 1];
        trial.trial_duration = (block_type === "delayed") ? Math.max(0, PRMS.iti - PRMS.fbDelay) : PRMS.iti;
    }
};
...
const TRIAL_TIMELINE = {
    timeline: [FIXATION_CROSS, FLANKER, PRE_FEEDBACK_DELAY, TRIAL_FEEDBACK, ITI],
...
const BLOCK_CONDITIONS = shuffle(["instant", "delayed"]).concat(
    shuffle(repeat_array(["instant", "delayed"], 6))
);
