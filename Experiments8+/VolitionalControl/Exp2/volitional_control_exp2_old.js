...
const PRMS = {
    ...
    wait_duration: 1000,
    iti: 1000,
    choice_selection_keys_same: ["E", "P"],
    choice_selection_keys_diff: ["D", "F"],
    task_keys_same: ["E", "P"],
    task_keys_diff: ["J", "K"],
...
Wahl linkes Bild: <span style="font-weight: bold">${PRMS.choice_selection_keys_same[0]}-Taste</span> (linker Zeigefinger)<br>
Wahl rechtes Bild: <span style="font-weight: bold">${PRMS.choice_selection_keys_same[1]}-Taste</span> (rechter Zeigefinger)<br><br>
Drücke eine beliebige Taste, um fortzufahren`,
            align: "left",
            color: "Black",
            fontsize: 30,
...
Kreis <span style="color: ${PRMS.cue_colours[0]}; font-weight: bold" >${EN_DE[PRMS.cue_colours[0]]}</span>: Freie Wahl<br>
Kreis <span style="color: ${PRMS.cue_colours[1]}; font-weight: bold" >${EN_DE[PRMS.cue_colours[1]]}: </span>vorgebene Wahl<br><br>
Wahl linkes Bild: <span style="font-weight: bold">${PRMS.choice_selection_keys_diff[0]}-Taste</span> (linker Mittelfinger)<br>
Wahl rechtes Bild: <span style="font-weight: bold">${PRMS.choice_selection_keys_diff[1]}-Taste</span> (linker Zeigefinger)<br><br>
Drücke eine beliebige Taste, um fortzufahren`,
            align: "left",
            color: "Black",
            fontsize: 30,
...
${EN_DE[PRMS.task_shapes[0]]}: ${PRMS.task_keys_same[0]}-Taste (linker Zeigefinger)<br>
${EN_DE[PRMS.task_shapes[1]]}: ${PRMS.task_keys_same[1]}-Taste (rechter Zeigefinger)<br><br>
Drücke eine beliebige Taste, um fortzufahren`,
            align: "left",
            color: "Black",
            fontsize: 30,
...
const TASK_INSTRUCTIONS_DIFF2 = {
    ...
    on_start: function (trial) {
        trial.stimulus = generate_formatted_html({
            text: `Nach dem ein Bild als Hintergrund gewählt wurde musst du auf eine weiß Form reagieren, welche rechts oder links auf dem Bildschirm präsentiert wird.<br><br>
Reagiere so schnell und genau wie möglich wie folgt:<br><br>
${EN_DE[PRMS.task_shapes[0]]}: ${PRMS.task_keys_diff[0]}-Taste (rechter Zeigefinger)<br>
${EN_DE[PRMS.task_shapes[1]]}: ${PRMS.task_keys_diff[1]}-Taste (rechter Mittelfinger)<br><br>
Drücke eine beliebige Taste, um fortzufahren`,
            align: "left",
            color: "Black",
            fontsize: 30,
...
Kreis <span style="color: ${PRMS.cue_colours[0]}; font-weight: bold" >${EN_DE[PRMS.cue_colours[0]]}</span>: Freie Wahl<br>
Kreis <span style="color: ${PRMS.cue_colours[1]}; font-weight: bold" >${EN_DE[PRMS.cue_colours[1]]}: </span>vorgebene Wahl<br><br>
Wahl linkes Bild: ${PRMS.choice_selection_keys_same[0]}-Taste (linker Zeigefinger)<br>
Wahl rechtes Bild: ${PRMS.choice_selection_keys_same[1]}-Taste (rechter Zeigefinger)<br><br>
...
Kreis <span style="color: ${PRMS.cue_colours[0]}; font-weight: bold" >${EN_DE[PRMS.cue_colours[0]]}</span>: Freie Wahl<br>
Kreis <span style="color: ${PRMS.cue_colours[1]}; font-weight: bold" >${EN_DE[PRMS.cue_colours[1]]}: </span>vorgebene Wahl<br><br>
Wahl linkes Bild: ${PRMS.choice_selection_keys_diff[0]}-Taste (linker Mittelfinger)<br>
Wahl rechtes Bild: ${PRMS.choice_selection_keys_diff[1]}-Taste (linker Zeigefinger)<br><br>
Bearbeite anschließend die Form-Aufgabe:<br><br>
${EN_DE[PRMS.task_shapes[0]]}: ${PRMS.task_keys_diff[0]}-Taste (rechter Zeigefinger)<br>
${EN_DE[PRMS.task_shapes[1]]}: ${PRMS.task_keys_diff[1]}-Taste (rechter Mittelfinger)<br><br>
Drücke eine beliebige Taste, um fortzufahren`,
...
function code_selection_response() {
    ...
    if (dat.choice_type === "free") {
        selection_side = jsPsych.pluginAPI.compareKeys(
            dat.response,
            dat.block === "same" ? PRMS.choice_selection_keys_same[0] : PRMS.choice_selection_keys_diff[0],
        )
            ? "left"
            : "right";
        // update t_interval
...
const CHOICE_IMAGE_SELECTION_SCREEN = {
    ...
    on_start: function (trial) {
        ...
        if (jsPsych.evaluateTimelineVariable("choice_type") === "free") {
            trial.choices =
                jsPsych.evaluateTimelineVariable("block") === "same"
                    ? PRMS.choice_selection_keys_same
                    : PRMS.choice_selection_keys_diff;
...
const CHOICE_IMAGE_FEEDBACK_SCREEN1 = {
    ...
    on_start: function (trial) {
        ...
        if (jsPsych.evaluateTimelineVariable("choice_type") === "free") {
            ...
            if (dat.block === "same") {
                trial.choices = [
                    dat.selection_side === "left"
                        ? PRMS.choice_selection_keys_same[0]
                        : PRMS.choice_selection_keys_same[1],
                ];
            } else if (dat.block === "diff") {
                trial.choices = [
                    dat.selection_side === "left"
                        ? PRMS.choice_selection_keys_diff[0]
                        : PRMS.choice_selection_keys_diff[1],
                ];
            }
            trial.stimulus = function (c) {
                draw_images(c, {
...
function draw_trial_feedback(c, args) {
    ...
    if (args.feedback_text !== "") {
        ...
        if (args.block === "same") {
            ctx.fillText(`${EN_DE[PRMS.task_shapes[0]]}: ${PRMS.task_keys_same[0]}-Taste`, -200, 100);
            ctx.fillText(`${EN_DE[PRMS.task_shapes[1]]}: ${PRMS.task_keys_same[1]}-Taste`, 200, 100);
        } else if (args.block === "diff") {
            ctx.fillText(`${EN_DE[PRMS.task_shapes[0]]}: ${PRMS.task_keys_diff[0]}-Taste`, -200, 100);
            ctx.fillText(`${EN_DE[PRMS.task_shapes[1]]}: ${PRMS.task_keys_diff[1]}-Taste`, 200, 100);
        }
    }
}
...
const TRIAL_FEEDBACK = {
    ...
    on_start: function (trial) {
        ...
        trial.stimulus = function (c) {
            draw_trial_feedback(c, { feedback_text: PRMS.feedback_text[dat.corr_code - 1], block: dat.block });
        };
    },
};
...
// prettier-ignore
const TRIAL_TABLE_SAME = [
  { block: "same", cue: PRMS.cue_colours[0], choice_type: "free",   task_shape: PRMS.task_shapes[0], task_position: "left",  correct_key: PRMS.task_keys_same[PRMS.task_shapes.indexOf(PRMS.task_shapes[0])]},
  { block: "same", cue: PRMS.cue_colours[0], choice_type: "free",   task_shape: PRMS.task_shapes[1], task_position: "left",  correct_key: PRMS.task_keys_same[PRMS.task_shapes.indexOf(PRMS.task_shapes[1])]},
  { block: "same", cue: PRMS.cue_colours[0], choice_type: "free",   task_shape: PRMS.task_shapes[0], task_position: "right", correct_key: PRMS.task_keys_same[PRMS.task_shapes.indexOf(PRMS.task_shapes[0])]},
  { block: "same", cue: PRMS.cue_colours[0], choice_type: "free",   task_shape: PRMS.task_shapes[1], task_position: "right", correct_key: PRMS.task_keys_same[PRMS.task_shapes.indexOf(PRMS.task_shapes[1])]},
  { block: "same", cue: PRMS.cue_colours[1], choice_type: "forced", task_shape: PRMS.task_shapes[0], task_position: "left",  correct_key: PRMS.task_keys_same[PRMS.task_shapes.indexOf(PRMS.task_shapes[0])]},
  { block: "same", cue: PRMS.cue_colours[1], choice_type: "forced", task_shape: PRMS.task_shapes[1], task_position: "left",  correct_key: PRMS.task_keys_same[PRMS.task_shapes.indexOf(PRMS.task_shapes[1])]},
  { block: "same", cue: PRMS.cue_colours[1], choice_type: "forced", task_shape: PRMS.task_shapes[0], task_position: "right", correct_key: PRMS.task_keys_same[PRMS.task_shapes.indexOf(PRMS.task_shapes[0])]},
  { block: "same", cue: PRMS.cue_colours[1], choice_type: "forced", task_shape: PRMS.task_shapes[1], task_position: "right", correct_key: PRMS.task_keys_same[PRMS.task_shapes.indexOf(PRMS.task_shapes[1])]},
];

// prettier-ignore
const TRIAL_TABLE_DIFF = [
  { block: "diff", cue: PRMS.cue_colours[0], choice_type: "free",   task_shape: PRMS.task_shapes[0], task_position: "left",  correct_key: PRMS.task_keys_diff[PRMS.task_shapes.indexOf(PRMS.task_shapes[0])]},
  { block: "diff", cue: PRMS.cue_colours[0], choice_type: "free",   task_shape: PRMS.task_shapes[1], task_position: "left",  correct_key: PRMS.task_keys_diff[PRMS.task_shapes.indexOf(PRMS.task_shapes[1])]},
  { block: "diff", cue: PRMS.cue_colours[0], choice_type: "free",   task_shape: PRMS.task_shapes[0], task_position: "right", correct_key: PRMS.task_keys_diff[PRMS.task_shapes.indexOf(PRMS.task_shapes[0])]},
  { block: "diff", cue: PRMS.cue_colours[0], choice_type: "free",   task_shape: PRMS.task_shapes[1], task_position: "right", correct_key: PRMS.task_keys_diff[PRMS.task_shapes.indexOf(PRMS.task_shapes[1])]},
  { block: "diff", cue: PRMS.cue_colours[1], choice_type: "forced", task_shape: PRMS.task_shapes[0], task_position: "left",  correct_key: PRMS.task_keys_diff[PRMS.task_shapes.indexOf(PRMS.task_shapes[0])]},
  { block: "diff", cue: PRMS.cue_colours[1], choice_type: "forced", task_shape: PRMS.task_shapes[1], task_position: "left",  correct_key: PRMS.task_keys_diff[PRMS.task_shapes.indexOf(PRMS.task_shapes[1])]},
  { block: "diff", cue: PRMS.cue_colours[1], choice_type: "forced", task_shape: PRMS.task_shapes[0], task_position: "right", correct_key: PRMS.task_keys_diff[PRMS.task_shapes.indexOf(PRMS.task_shapes[0])]},
  { block: "diff", cue: PRMS.cue_colours[1], choice_type: "forced", task_shape: PRMS.task_shapes[1], task_position: "right", correct_key: PRMS.task_keys_diff[PRMS.task_shapes.indexOf(PRMS.task_shapes[1])]},
];

const TRIAL_TIMELINE_SAME = {
    timeline: [
        FIXATION_CROSS_800,
        COLOUR_CUE,
        FIXATION_CROSS_500,
    ...
    timeline_variables: TRIAL_TABLE_SAME,
};

const TRIAL_TIMELINE_DIFF = {
    timeline: [
        FIXATION_CROSS_800,
        COLOUR_CUE,
        FIXATION_CROSS_500,
    ...
    timeline_variables: TRIAL_TABLE_DIFF,
};
...
function generate_exp() {
    ...
    let blk_type;
    if (VERSION === 1) {
        blk_type = repeat_array(["same"], PRMS.nblks / 2).concat(repeat_array(["diff"], PRMS.nblks / 2));
    } else if (VERSION === 2) {
        blk_type = repeat_array(["diff"], PRMS.nblks / 2).concat(repeat_array(["same"], PRMS.nblks / 2));
    }
    ...
    for (let blk = 0; blk < PRMS.nblks; blk++) {
        ...
        if ((blk === 0 && VERSION === 1) || (blk === PRMS.nblks / 2 && VERSION == 2)) {
            exp.push(TASK_INSTRUCTIONS_SAME1);
            exp.push(TASK_INSTRUCTIONS_SAME2);
        } else if ((blk === 0 && VERSION === 2) || (blk === PRMS.nblks / 2 && VERSION == 1)) {
            exp.push(TASK_INSTRUCTIONS_DIFF1);
            exp.push(TASK_INSTRUCTIONS_DIFF2);
        }
        exp.push(PRELOAD);
        let blk_timeline;
        if (blk_type[blk] === "same") {
            exp.push(BLOCK_START_SAME);
            blk_timeline = { ...TRIAL_TIMELINE_SAME };
            blk_timeline.sample = {
                type: "fixed-repetitions",
                size: practice_blocks.includes(blk)
                    ? PRMS.ntrlsp / TRIAL_TABLE_SAME.length
                    : PRMS.ntrlse / TRIAL_TABLE_SAME.length,
            };
        } else if (blk_type[blk] === "diff") {
            exp.push(BLOCK_START_DIFF);
            blk_timeline = { ...TRIAL_TIMELINE_DIFF };
            blk_timeline.sample = {
                type: "fixed-repetitions",
                size: practice_blocks.includes(blk)
                    ? PRMS.ntrlsp / TRIAL_TABLE_DIFF.length
                    : PRMS.ntrlse / TRIAL_TABLE_DIFF.length,
            };
        }
