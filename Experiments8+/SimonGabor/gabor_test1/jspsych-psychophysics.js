...
${indent}columns: ${matrix.columns}
    ...
    function formatNumber(num, maxNumSize, padMinus) {
        return (
            num >= 0 && padMinus ? ` ${formatNumber2(num, maxNumSize - 1)}` : formatNumber2(num, maxNumSize)
        ).padEnd(maxNumSize);
    }
    ...
    class SymmetricMatrix extends AbstractMatrix {
        ...
        static fromCompact(compact) {
            ...
            // sideSize = (Sqrt(8 ﾃ� compactSize + 1) - 1) / 2
            const diagonalSize = (Math.sqrt(8 * compactSize + 1) - 1) / 2;

            if (!Number.isInteger(diagonalSize)) {
                throw new TypeError(
                    `This array is not a compact representation of a Symmetric Matrix, ${JSON.stringify(compact)}`,
                );
            }
    ...
    class DistanceMatrix extends SymmetricMatrix {
        ...
        static fromCompact(compact) {
            ...
            // compactSize in Natural integer range ]0;竏枉
            // compactSize = (sideSize * (sideSize - 1)) / 2
            // sideSize = (Sqrt(8 ﾃ� compactSize + 1) + 1) / 2
            const diagonalSize = (Math.sqrt(8 * compactSize + 1) + 1) / 2;
            ...
            if (!Number.isInteger(diagonalSize)) {
                throw new TypeError(
                    `This array is not a compact representation of a DistanceMatrix, ${JSON.stringify(compact)}`,
                );
            }
            ...
            if (l === n) {
                ...
                while (m >= l) {
                    ...
                    if (
                        ...
                        eps *
                            (Math.abs(p) *
                                (Math.abs(H.get(m - 1, m - 1)) + Math.abs(z) + Math.abs(H.get(m + 1, m + 1))))
                    ) {
                        break;
                    }
                    m--;
        ...
        trial(display_element, trial) {
            ...
            class visual_stimulus extends psychophysics_stimulus {
                constructor(stim) {
                    ...
                    if (typeof this.motion_start_time === "undefined") this.motion_start_time = this.show_start_time;
                    if (typeof this.motion_end_time === "undefined") this.motion_end_time = null;
                    if (typeof this.motion_start_frame === "undefined") this.motion_start_frame = this.show_start_frame;
                ...
                calc_pix_per_sec(direction) {
                    ...
                    if (
                        (typeof pix_sec !== "undefined" || typeof pix_frame !== "undefined") &&
                        endPos !== null &&
                    ...
                    if (typeof pix_sec !== "undefined" || typeof pix_frame !== "undefined") return pix_sec;
            ...
            function step(timestamp) {
                ...
                if (trial.clear_canvas && !trial.pixi) ctx.clearRect(0, 0, canvas.width, canvas.height);
