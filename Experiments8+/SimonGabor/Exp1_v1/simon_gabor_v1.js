...
const PRMS = {
    ...
    noise_high: 0.5,                 // RMS amplitude for high noise background
...
function generateBackgroundImages() {
    ...
    const highImage = generateNoiseLevel(width, height, PRMS.noise_freq_high, PRMS.noise_bandwidth_high, PRMS.noise_high);
