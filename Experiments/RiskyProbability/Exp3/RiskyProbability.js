...
// read all emoji images and shuffle order
let imgsExperience = shuffle(readImages("ExperienceImages/E_", 34));

// "safe" images
let imgsSafeGain = imgsExperience.splice(0, 3);
let imgsSafeLoss = imgsExperience.splice(0, 3);

// "risky" images
let imgsRiskyGain = imgsExperience.splice(0, 3);
let imgsRiskyLoss = imgsExperience.splice(0, 3);

console.log(imgsSafeGain);
console.log(imgsSafeLoss);
console.log(imgsRiskyGain);
console.log(imgsRiskyLoss);
...
jsPsych.init({
    ...
    on_finish: function () {
        window.location.assign(
            "https://uni-tuebingen.sona-systems.com/webstudy_credit.aspx?experiment_id=172&credit_token=12ed89b6830b46ffb607387e59c8602b&survey_code=" +
