...
let learning_block_description = [
  ...
  {
    phase: 'learning',
    trialType: 'PureDescription',
    imageTypeLeft: 'Description',
    imageTypeRight: 'Description',
    imageProbLeft: 0.2,
    imageProbRight: 0.8,
    imageNumberLeft: 0,
    imageNumberRight: 2,
...
let learning_block_experience = [
  ...
  {
    phase: 'learning',
    trialType: 'PureExperience',
    imageTypeLeft: 'Experience',
    imageTypeRight: 'Experience',
    imageProbLeft: 0.2,
    imageProbRight: 0.8,
    imageNumberLeft: 0,
    imageNumberRight: 2,
