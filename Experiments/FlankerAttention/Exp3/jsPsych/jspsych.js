    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        //DOM_target.innerHTML = '<div style=""><p>The experiment will launch in fullscreen mode when you click the button below.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Launch Experiment</button></div>';
          DOM_target.innerHTML = '<div style=""><p>Das Experiment wird im Vollbildmodus ablaufen, wenn Sie auf den Button klicken.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Launch Experiment</button></div>';
