...
const task_instructions_pp = {
  ...
  stimulus:
    ...
    "<h3 style='text-align: left;'>Die erste Priorität ist auf den mittleren Buchstaben weiterhin wie folgt zu reagieren:</h3><br>" +
    respText_base +
    "<h3 style='text-align: left;'>Wenn der Buchstabe in der Mitte aber " +
    prms.respLetters[2] +
    ' ist, dann reagiere auf die</h3>' +
    "<h3 style='text-align: left;'>umliegenden (links/rechts) Buchstaben (zweite Priorität):</h3><br>" +
    respText_pp +
    "<h2 style='text-align: center;'>Drücke eine beliebige Taste, um fortzufahren!</h2>",
};
...
const task_instructions_pp_reminder = {
  ...
  on_start: function (trial) {
    trial.stimulus =
      ...
      prms.cBlk +
      ' von 24:</h2><br>' +
      "<h3 style='text-align: left;'>Erste Priorität ist der mittige Buchstabe:</h3>" +
      respText_base +
