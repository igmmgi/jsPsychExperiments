...
//  Simon compatibility (comp vs. incomp) X Response Box Size (small vs. large)
...
stimuli_small = [
  ...
  { stim: 'H', side: 'right', resp_size: 'small', resp_loc: prms.resp_loc[0] },
];
  ...
  stimulus: generate_formatted_html({
    text:
      `Vielen Dank für Ihre Teilnahme.<br><br>
        ...
        an:<br><br>nikolas.maier@student.uni-tuebingen.de<br> Code: ` +
      randomString +
