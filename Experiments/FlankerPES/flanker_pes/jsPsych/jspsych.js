  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.innerHTML = '<div style=""><p>Das Experiment wird im Vollbildmodus geöffnet.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Experiment starten</button></div>';
