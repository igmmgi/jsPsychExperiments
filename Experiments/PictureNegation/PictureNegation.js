...
const materials_ja_aff = [
    ...
    { sentNum:  18, sentence: "Sie finden ein Rätsel.",                          sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  23, sentence: "Sie bauen ein Haus.",                             sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  27, sentence: "Sie essen heute Pizza.",                          sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    { sentNum:  28, sentence: "Sie pflücken viele Erdbeeren.",                   sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  48, sentence: "Sie pflücken einen Apfel.",                       sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  69, sentence: "Sie mögen den Kuchen.",                           sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  76, sentence: "Sie riechen jetzt an der Blume.",                 sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  93, sentence: "Sie schälen die Kartoffeln.",                     sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    ...
    { sentNum: 113, sentence: "Sie treffen heute viele Leute.",                  sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    { sentNum: 114, sentence: "Sie lesen viele Bücher.",                         sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    { sentNum: 115, sentence: "Sie knabbern an einer Karotte.",                  sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    { sentNum: 116, sentence: "Sie übernachten heute bei ihrem Vater.",          sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
    { sentNum: 117, sentence: "Sie treffen heute ihre Schwester.",               sinn: "ja",   pol: "aff", corrResp: prms.respKeys[0] },
...
const materials_nein_aff = [
    ...
    { sentNum: 142, sentence: "Sie schwören ein Gericht.",                       sinn: "nein", pol: "aff", corrResp: prms.respKeys[1] },
    ...
    { sentNum: 147, sentence: "Sie wachsen ein Kabel.",                          sinn: "nein", pol: "aff", corrResp: prms.respKeys[1] },
    ...
    { sentNum: 184, sentence: "Sie reden jetzt einen Stift.",                    sinn: "nein", pol: "aff", corrResp: prms.respKeys[1] },
    { sentNum: 185, sentence: "Sie tauchen heute im Papagei.",                   sinn: "nein", pol: "aff", corrResp: prms.respKeys[1] },
    { sentNum: 186, sentence: "Sie erfahren jetzt eine Maus.",                   sinn: "nein", pol: "aff", corrResp: prms.respKeys[1] },
...
const materials_ja_neg = [
    ...
    { sentNum:   7, sentence: "Sie braten kein Fleisch.",                        sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  18, sentence: "Sie finden kein Rätsel.",                         sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  22, sentence: "Sie feiern heute kein Jubiläum.",                 sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    { sentNum:  23, sentence: "Sie bauen kein Haus.",                            sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  33, sentence: "Sie empfiehlen kein Restaurant.",                 sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  48, sentence: "Sie pflücken keinen Apfel.",                      sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  61, sentence: "Sie treffen nicht ihre Familie.",                 sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    { sentNum:  62, sentence: "Sie gehen nicht zur Oma.",                        sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  76, sentence: "Sie riechen nicht an der Blume.",                 sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    ...
    { sentNum:  92, sentence: "Sie bestellt kein Sofa.",                         sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    { sentNum:  93, sentence: "Sie schälen keine Kartoffeln.",                   sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    ...
    { sentNum: 113, sentence: "Sie treffen nicht viele Leute.",                  sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    { sentNum: 114, sentence: "Sie lesen keine Bücher.",                         sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    { sentNum: 115, sentence: "Sie knabbern an keiner Karotte.",                 sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    { sentNum: 116, sentence: "Sie übernachten nicht bei ihrem Vater.",          sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
    { sentNum: 117, sentence: "Sie treffen nicht ihre Schwester.",               sinn: "ja",   pol: "neg", corrResp: prms.respKeys[0] },
...
const materials_nein_neg = [
    ...
    { sentNum: 142, sentence: "Sie schwören kein Gericht.",                      sinn: "nein", pol: "neg", corrResp: prms.respKeys[1] },
    ...
    { sentNum: 147, sentence: "Sie wachsen kein Kabel.",                         sinn: "nein", pol: "neg", corrResp: prms.respKeys[1] },
    ...
    { sentNum: 151, sentence: "Sie gedeiht keine Braut.",                        sinn: "nein", pol: "neg", corrResp: prms.respKeys[1] },
    ...
    { sentNum: 184, sentence: "Sie reden nicht einen Stift.",                    sinn: "nein", pol: "neg", corrResp: prms.respKeys[1] },
    ...
    { sentNum: 194, sentence: "Sie bremsen keinen Teppich.",                     sinn: "nein", pol: "neg", corrResp: prms.respKeys[1] },
    ...
    { sentNum: 207, sentence: "Sie galoppoeren keinen Eimer.",                   sinn: "nein", pol: "neg", corrResp: prms.respKeys[1] },
    ...
    { sentNum: 233, sentence: "Sie schrauben keinen Lauf.",                      sinn: "nein", pol: "neg", corrResp: prms.respKeys[1] },
    ...
    { sentNum: 237, sentence: "Sie kneten nicht ein Geräusch.",                  sinn: "nein", pol: "neg", corrResp: prms.respKeys[1] },
