...
const task_instructions2 = {
  ...
  stimulus:
    ...
    "<H2 style='text-align:center;'>'J' key = " +
    cols[prms.respKeysStroop.indexOf('J')] +
    "&emsp; 'K' key = " +
    cols[prms.respKeysStroop.indexOf('K')] +
    "&emsp; 'L' key = " +
    cols[prms.respKeysStroop.indexOf('L')] +
    '</H2><br>' +
...
const task_instructions4 = {
  ...
  canvas_border: canvas_border,
  stimulus:
    "<H1 style='text-align:center;'>Part 3: Practice Block</H1><br>" +
    ...
    "<H2 style='text-align:center;'>'A' key = " +
    sens[prms.respKeysSentence.indexOf('A')] +
    "&emsp; 'S' key = " +
    sens[prms.respKeysSentence.indexOf('S')] +
    '</H2><br>' +
...
const task_instructions5 = {
  ...
  canvas_border: canvas_border,
  stimulus:
    "<H1 style='text-align:center;'>Part 4: Real Block</H1><br>" +
    "<H2 style='text-align:center;'>Respond to the color of the font with your right hand.</H2>" +
    "<H2 style='text-align:center;'>Use your index, middle, and ring-fingers (one per key).</H2><br>" +
    "<H2 style='text-align:center;'>'J' key = " +
    cols[prms.respKeysStroop.indexOf('J')] +
...
const sentence_materials_incong = shuffle([
  ...
  {
    type: 'sentence',
    text: 'Newspapers are delicate.',
    colour: 'black',
    cong: 'incong',
    key: prms.respKeysSentence[1],
  },
