...
const task_instructions_prp = {
  ...
  stimulus:
    ...
    '</h3><br>' +
    "<h3 style='text-align: left;'>Warte nicht mit der Bearbeitung der 1. Aufgabe bis die 2. Aufgabe präsentiert wird!</h3><br>" +
    "<h2 style='text-align: center;'>Drücke eine beliebige Taste, um fortzufahren!</h2>",
};
...
const task_instructions_ts = {
  ...
  stimulus:
    ...
    "<h3 style='text-align: center;'>Tonaufgabe: Zeigefinger</h3>" +
    "<h3 style='text-align: center;'>Pfeilaufgabe: Mittelfinger</h3><br>" +
    "<h2 style='text-align: left;'>&emsp;&emsp;&emsp;&emsp;&emsp;" +
    prms.respArrows[0] +
    '&emsp;&emsp;&emsp;&emsp;&emsp;' +
    'Tiefer Ton' +
...
function drawFeedbackPRP() {
  ...
  if (dat.corrCode !== 1) {
    ctx.fillText('Aufgabe 1 (Tonaufgabe): Zeigefinger', 0, 50);
...
const trial_timeline_prp = {
  ...
  timeline_variables: [
    ...
    { task: "prp", arrow: prms.respArrows[1], arrowDirection: 'right', tone: prms.respTones[0], soa: prms.soa[0], corrResp1: prms.respKeys1[0], corrResp2: prms.respKeys2[1] },
    { task: "prp", arrow: prms.respArrows[0], arrowDirection: 'left',  tone: prms.respTones[1], soa: prms.soa[0], corrResp1: prms.respKeys1[1], corrResp2: prms.respKeys2[0] },
    ...
    { task: "prp", arrow: prms.respArrows[1], arrowDirection: 'right', tone: prms.respTones[0], soa: prms.soa[1], corrResp1: prms.respKeys1[0], corrResp2: prms.respKeys2[1] },
    { task: "prp", arrow: prms.respArrows[0], arrowDirection: 'left',  tone: prms.respTones[1], soa: prms.soa[1], corrResp1: prms.respKeys1[1], corrResp2: prms.respKeys2[0] },
...
const trial_timeline_task_switch = {
  ...
  timeline_variables: [
    { task: "arrow", arrow: prms.respArrows[0], arrowDirection: 'left',  tone: prms.respTones[0], soa: null, corrResp1: prms.respKeys2[0], corrResp2: null },
    { task: "arrow", arrow: prms.respArrows[1], arrowDirection: 'right', tone: prms.respTones[0], soa: null, corrResp1: prms.respKeys2[1], corrResp2: null },
    { task: "arrow", arrow: prms.respArrows[0], arrowDirection: 'left',  tone: prms.respTones[1], soa: null, corrResp1: prms.respKeys2[0], corrResp2: null },
    { task: "arrow", arrow: prms.respArrows[1], arrowDirection: 'right', tone: prms.respTones[1], soa: null, corrResp1: prms.respKeys2[1], corrResp2: null },
    ...
    { task: "tone",  arrow: prms.respArrows[1], arrowDirection: 'right', tone: prms.respTones[0], soa: null, corrResp1: prms.respKeys1[0], corrResp2: null },
    { task: "tone",  arrow: prms.respArrows[0], arrowDirection: 'left',  tone: prms.respTones[1], soa: null, corrResp1: prms.respKeys1[1], corrResp2: null },
