...
if (nVersion === 1) {
  ...
  prms.respKeysSize = ['Q', 'P', 27];
  respText =
    "<h2 style='text-align: center;'>Leben: Nicht Lebendig = 'Q' &emsp;&emsp; Lebendig = 'P'</h4>" +
