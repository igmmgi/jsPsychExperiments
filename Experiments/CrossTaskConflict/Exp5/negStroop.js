...
var stroop = [
  ...
  {
    stimulus: "<h1 style='color:red'>grün</h1>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
  ...
  {
    stimulus: "<h1 style='color:red'>gelb</h1>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
  ...
  {
    stimulus: '<h1 style="color:blue">grün</h1>',
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
   ...
   {
    stimulus: '<h1 style="color:blue">gelb</h1>',
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
...
var negStroop = stroop.concat(word, word);
...
function blockFeedbackTxt(){
    ...
    dat = jsPsych.data.get().filter({stim:"negStroop", corrCode: 1});
