/*
 ...
 ignoring the surrounding arrows using key responses ("X" and "M").
...
var instructions = {
  ...
  text: "<h1 align='left'>Aufgabe:</h1>" +
    "<h2 align='left'>Reagieren Sie auf die Ausrichtung des mittleren Pfeils:</h2><br>" +
...
var flanker= [{
    stimulus: "<div class='left' style='float: left'></div>" + "<div class='left' style='float: left'></div>" + "<div class='left' style='float: right'></div>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
    data: {stim: "flanker", dim:"hor", respDir: "left", comp: "comp", corrResp: respKeys[0]}
}, {
    stimulus: "<div class='right' style='float: left'</div>" + "<div class='left'  style='float: left'></div>" + "<div class='right' style='float: right'></div>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    data: {stim: "flanker", dim:"hor", respDir: "left", comp: "incomp", corrResp: respKeys[0]}
}, {
    stimulus: "<div class='right' style='float: left'></div>" + "<div class='right' style='float: left'></div>" + "<div class='right' style='float: right'></div>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
    data: {stim: "flanker", dim:"hor", respDir: "right", comp: "comp", corrResp: respKeys[1]}
}, {
    stimulus: "<div class='left'  style='float: left'></div>" + "<div class='right' style='float: left'></div>" + "<div class='left'  style='float: right'></div>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
    data: {stim: "flanker", dim:"hor", respDir: "right", comp: "incomp", corrResp: respKeys[1]}
}, {
    stimulus: "<div class='left'></div>" + "<div class='left'></div>" + "<div class='left'></div>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
    data: {stim: "flanker", dim:"ver", respDir: "left", comp: "comp", corrResp: respKeys[0]}
}, {
    stimulus: "<div class='right'></div>" + "<div class='left'></div>" + "<div class='right'></div>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    data: {stim: "flanker", dim:"ver", respDir: "left",  comp: "incomp", corrResp: respKeys[0]}
}, {
    stimulus: "<div class='right'></div>" + "<div class='right'></div>" + "<div class='right'></div>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
    data: {stim: "flanker", dim:"ver", respDir: "right", comp: "comp", corrResp: respKeys[1]}
}, {
    stimulus: "<div class='left'></div>" + "<div class='right'></div>" + "<div class='left'></div>",
    is_html: true,
    timing_response: tooSlow,
    timing_post_trial: 0,
    response_ends_trial: true,
    data: {stim: "flanker", dim:"ver", respDir: "right", comp: "incomp", corrResp: respKeys[1]}
}
];
