...
const prms = {
  ...
  taskInstructions: [1, 2].includes(version) ? ['< 153', '> 153', '< M', '> M'] : ['< M', '> M', '< 153', '> 153'],
...
const task_instructions3 = {
  ...
  stimulus:
    ...
    "<h3 style='text-align: left;'>Für die Zahlenaufgabe musst du entscheiden ob die Zahl kleiner oder größer 153 ist.</h3>" +
