...
jsPsych.plugins['html-keyboard-response-canvas-min-duration'] = (function () {
  let plugin = {};

  plugin.info = {
    name: 'html-keyboard-response-canvas-min-duration',
    description: '',
    parameters: {
      stimulus: {
      ...
      minimum_trial_duration: {
        ...
        default: null,
        description: 'Minimum time to show trial stimulus.',
      },
      response_ends_trial: {
        type: jsPsych.plugins.parameterType.BOOL,
  ...
  plugin.trial = function (display_element, trial) {
    ...
    let after_response = function (info) {
      ...
      if (response.key == null) {
        ...
        if (trial.minimum_trial_duration !== null) {
          if (response.rt < trial.minimum_trial_duration) {
            response.key = null;
            response.rt += info.rt;
            ...
            trial.minimum_trial_duration = null;
          }
        }
      }

      if (trial.response_ends_trial && trial.minimum_trial_duration === null) {
        end_trial();
      }
    };
