...
function saveData(url, filename, rows = {}, colsToIgnore = ["stimulus", "trial_type", "internal_node_id", "trial_index", "time_elapsed"]) {
...
const debrief_de = {
  type: "html-keyboard-response",
  stimulus: "<h1>Das Experiment ist beendet.</h1>" + "<h2>Drücken Sie eine beliebige Taste, um das Experiment zu beenden!</h2>",
  response_ends_trial: true,
};

const debrief_de_du = {
  type: "html-keyboard-response",
  stimulus: "<h1>Das Experiment ist beendet.</h1>" + "<h2>Drücke eine beliebige Taste, um das Experiment zu beenden!</h2>",
  response_ends_trial: true,
};
