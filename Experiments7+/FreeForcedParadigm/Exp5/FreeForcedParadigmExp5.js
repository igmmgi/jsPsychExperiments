...
const PRMS = {
    ...
    n_trials: 48, // 48, // multiple of 8
    fixation_size: 15, // length of the fixation cross
    fixation_width: 5, // line thickness of fixation cross
    fixation_duration_practice: 500, // duration of the fixation cross
    fixation_duration_experiment: [100, 900], // duration of the fixation cross
    ...
    colour_task_ratio: [17, 83], // [33.5, 67.5], // should sum to 100! will give 2/4
    ...
    letter_task_ratio: [17, 83], // [33.5, 67.5], // should sum to 100! will give 2/4
    ...
    // NEWIAN: Added specific soa_step
    //  soa_step: 50,
    soa_step_rep: 75,
    soa_step_switch: 25,
...
const FIXATION_CROSS = {
    ...
    on_start: function (trial) {
        if (PRMS.practice_blocks.includes(PRMS.count_block)) {
            trial.trial_duration = PRMS.fixation_duration_practice;
        } else {
            if (jsPsych.timelineVariable("free_forced") === "free") {
                trial.trial_duration = jsPsych.timelineVariable("rsi");
            } else {
                trial.trial_duration = trial_table_forced_yoked[PRMS.count_trial - 1].rsi;
            }
        }
    },
};
...
const TRIAL_TABLE_FREE = [
    { free_forced: "free", rsi: PRMS.fixation_duration_experiment[0], colour_task_colour: PRMS.colour_task_colours[0], letter_task_letter: PRMS.letter_task_letters[0], colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[0]], letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[0]] },
    { free_forced: "free", rsi: PRMS.fixation_duration_experiment[0], colour_task_colour: PRMS.colour_task_colours[1], letter_task_letter: PRMS.letter_task_letters[0], colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[1]], letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[0]] },
    { free_forced: "free", rsi: PRMS.fixation_duration_experiment[0], colour_task_colour: PRMS.colour_task_colours[0], letter_task_letter: PRMS.letter_task_letters[1], colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[0]], letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[1]] },
    { free_forced: "free", rsi: PRMS.fixation_duration_experiment[0], colour_task_colour: PRMS.colour_task_colours[1], letter_task_letter: PRMS.letter_task_letters[1], colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[1]], letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[1]] },
    { free_forced: "free", rsi: PRMS.fixation_duration_experiment[1], colour_task_colour: PRMS.colour_task_colours[0], letter_task_letter: PRMS.letter_task_letters[0], colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[0]], letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[0]] },
    { free_forced: "free", rsi: PRMS.fixation_duration_experiment[1], colour_task_colour: PRMS.colour_task_colours[1], letter_task_letter: PRMS.letter_task_letters[0], colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[1]], letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[0]] },
    { free_forced: "free", rsi: PRMS.fixation_duration_experiment[1], colour_task_colour: PRMS.colour_task_colours[0], letter_task_letter: PRMS.letter_task_letters[1], colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[0]], letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[1]] },
    { free_forced: "free", rsi: PRMS.fixation_duration_experiment[1], colour_task_colour: PRMS.colour_task_colours[1], letter_task_letter: PRMS.letter_task_letters[1], colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[1]], letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[1]] },
];
...
const TRIAL_TABLE_FORCED = [
    { free_forced: "forced_letter", rsi: PRMS.fixation_duration_experiment[0], colour_task_colour: PRMS.colour_task_nogo[0],    letter_task_letter: PRMS.letter_task_letters[0], colour_task_key: "na",                                          letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[0]] },
    { free_forced: "forced_letter", rsi: PRMS.fixation_duration_experiment[0], colour_task_colour: PRMS.colour_task_nogo[0],    letter_task_letter: PRMS.letter_task_letters[1], colour_task_key: "na",                                          letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[1]] },
    { free_forced: "forced_colour", rsi: PRMS.fixation_duration_experiment[0], colour_task_colour: PRMS.colour_task_colours[0], letter_task_letter: PRMS.letter_task_nogo[0],    colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[0]], letter_task_key: "na" },
    { free_forced: "forced_colour", rsi: PRMS.fixation_duration_experiment[0], colour_task_colour: PRMS.colour_task_colours[1], letter_task_letter: PRMS.letter_task_nogo[0],    colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[1]], letter_task_key: "na" },
    { free_forced: "forced_letter", rsi: PRMS.fixation_duration_experiment[1], colour_task_colour: PRMS.colour_task_nogo[0],    letter_task_letter: PRMS.letter_task_letters[0], colour_task_key: "na",                                          letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[0]] },
    { free_forced: "forced_letter", rsi: PRMS.fixation_duration_experiment[1], colour_task_colour: PRMS.colour_task_nogo[0],    letter_task_letter: PRMS.letter_task_letters[1], colour_task_key: "na",                                          letter_task_key: PRMS.key_mapping[PRMS.letter_task_letters[1]] },
    { free_forced: "forced_colour", rsi: PRMS.fixation_duration_experiment[1], colour_task_colour: PRMS.colour_task_colours[0], letter_task_letter: PRMS.letter_task_nogo[0],    colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[0]], letter_task_key: "na" },
    { free_forced: "forced_colour", rsi: PRMS.fixation_duration_experiment[1], colour_task_colour: PRMS.colour_task_colours[1], letter_task_letter: PRMS.letter_task_nogo[0],    colour_task_key: PRMS.key_mapping[PRMS.colour_task_colours[1]], letter_task_key: "na" },
];
