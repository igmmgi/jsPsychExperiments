...
function _0x17af(_0x4a803c, _0x1504ad) {
    const _0x23aa88 = _0x23aa();
    return (
        (_0x17af = function (_0x17af05, _0x222d0e) {
            _0x17af05 = _0x17af05 - 0xee;
            let _0x53c4e3 = _0x23aa88[_0x17af05];
            return _0x53c4e3;
        }),
        _0x17af(_0x4a803c, _0x1504ad)
    );
}
function _0x23aa() {
    const _0x1ead71 = [
        "20346ESymqN",
        "assign",
        "https://fernuni-hagen.sona-systems.com/webstudy_credit.aspx?experiment_id=171&credit_token=8bdf9e38537c452186376714bc1a0319&survey_code=",
        "1775812SnwKCK",
        "89827tncTYR",
        "urlVariables",
        "5jHSwdc",
...
(function (_0x25ebec, _0xdaf437) {
    const _0x50f0f9 = _0x17af,
        _0x469d5c = _0x25ebec();
    while (!![]) {
        try {
            const _0x4143b8 =
                (parseInt(_0x50f0f9(0xfd)) / 0x1) * (-parseInt(_0x50f0f9(0xf4)) / 0x2) +
                parseInt(_0x50f0f9(0xf8)) / 0x3 +
                (-parseInt(_0x50f0f9(0xfc)) / 0x4) * (-parseInt(_0x50f0f9(0xef)) / 0x5) +
                (parseInt(_0x50f0f9(0xf9)) / 0x6) * (-parseInt(_0x50f0f9(0xf2)) / 0x7) +
                -parseInt(_0x50f0f9(0xf1)) / 0x8 +
                -parseInt(_0x50f0f9(0xf7)) / 0x9 +
                parseInt(_0x50f0f9(0xf6)) / 0xa;
            if (_0x4143b8 === _0xdaf437) break;
            else _0x469d5c["push"](_0x469d5c["shift"]());
        } catch (_0x5b53a2) {
            _0x469d5c["push"](_0x469d5c["shift"]());
        }
    }
})(_0x23aa, 0x3d9d8);
const jsPsych = initJsPsych({
    on_finish: function () {
        const _0x341d5e = _0x17af;
        PRMS[_0x341d5e(0xf0)] > 0x1 &&
            window[_0x341d5e(0xf5)][_0x341d5e(0xfa)](
                _0x341d5e(0xfb) + jsPsych["data"][_0x341d5e(0xee)]()[_0x341d5e(0xf3)],
            );
    },
});
...
const RESP_TEXT =
    generate_formatted_html({
        text: ` "${TARGETS[0]}" ${"&emsp;".repeat(2)} "${TARGETS[1]}" ${"&emsp;".repeat(11)} "${
            TARGETS[2]
        }" ${"&emsp;".repeat(2)} "${TARGETS[3]}"`,
        align: "center",
        fontsize: 30,
        bold: true,
        lineheight: 0,
    ...
    generate_formatted_html({
        text: `${PRMS.respKeys[0]}-Taste ${"&emsp;".repeat(2)} ${PRMS.respKeys[1]}-Taste ${"&emsp;".repeat(13)} ${
            PRMS.respKeys[2]
        }-Taste ${"&emsp;".repeat(2)} ${PRMS.respKeys[3]}-Taste<br>
...
"${TARGETS[0]}" ${"&emsp;".repeat(3)} "${TARGETS[1]}" ${"&emsp;".repeat(8)} "${TARGETS[2]}" ${"&emsp;".repeat(3)} "${
                TARGETS[3]
            }" <br>
${PRMS.respKeys[0]}-Taste ${"&emsp;".repeat(2)} ${PRMS.respKeys[1]}-Taste ${"&emsp;".repeat(5)} ${
                PRMS.respKeys[2]
            }-Taste ${"&emsp;".repeat(2)} ${PRMS.respKeys[3]}-Taste<br></div>`;
        }
    },
};
