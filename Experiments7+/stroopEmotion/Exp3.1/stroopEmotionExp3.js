    ...
    on_finish: function () {
        if (PRMS.cBlk >= 13) {
            window.location.assign(
                "https://uni-tuebingen.sona-systems.com/webstudy_credit.aspx?experiment_id=351&credit_token=290e950fb9524fc2b410f32abadf14b0&survey_code=" +
...
// font options
// 1: "Comic Sans MS, Comic Sans, cursive";
// 2: "Georgia, Times, serif";

// task choice
// reaction_task: Reaktions-Aufgabe             CHOICES.task_choice = "reaction_task";
// attention_task: Aufmerksamkeits-Aufgabe             CHOICES.task_choice = "reaction_task";

// change this only!
const CHOICES = {
    mood: null,
    task_choice: "reaction_task",
    task_choice_de: "Reaktions-Aufgabe",
    colour_choice: "green",
    colour_choice_hex: "#259F25",
    font_choice_number: 1,
    font_choice: "Comic Sans MS, Comic Sans, cursive",
};

const EN_DE = { blue: "blau", green: "grün" };
...
const CHOICE_SCREEN = {
    ...
    canvas_border: CANVAS_BORDER,
    stimulus: generate_formatted_html({
        text: `Für dieses Experiment müssen vom Programm erst verschiedene Einstellungen und die Aufgabe,
welche du bearbeiten sollst, gewählt werden.<br><br>
...
const COLOUR_CHOICE_SCREEN1 = {
    ...
    stimulus: generate_formatted_html({
        text: `Die nächsten 20 Sekunden wird entschieden, welche Farbe der
Hintergrund in deinem Experiment haben soll:<br><br>
...
const COLOUR_CHOICE_SCREEN2 = {
    ...
    stimulus: generate_formatted_html({
        text: `Es wurde <span style="color: ${CHOICES.colour_choice};">${
            EN_DE[CHOICES.colour_choice]
        }</span> für dich gewählt.<br><br>
Zum Weitermachen drücke bitte eine beliebige Taste.`,
        align: "left",
        colour: "black",
        fontsize: 30,
...
const FONT_CHOICE_SCREEN1 = {
    ...
    trial_duration: PRMS.thinkDur,
    stimulus: generate_formatted_html({
        text: `Im folgenden Experiment musst du Wörter klassifizieren. Die nächsten
20 Sekunden wird entschieden, in welcher Schriftart die Wörter präsentiert werden sollen.<br><br>
...
const FONT_CHOICE_SCREEN2 = {
    ...
    response_ends_trial: true,
    stimulus: generate_formatted_html({
        text: ` Es wurde Schriftart ${CHOICES.font_choice_number} für dich gewählt.<br><br>
Zum Weitermachen drücke bitte eine beliebige Taste.`,
        align: "left",
        colour: "black",
        fontsize: 30,
...
const TASK_CHOICE_SCREEN2 = {
    ...
    on_start: function (trial) {
        trial.stimulus = generate_formatted_html({
            text: `<span style="font-family: ${CHOICES.font_choice}">Aktuelle Forschung zeigt, dass eine spezifische Kombination aus Farbe, Schriftart und Aufgabe eine
positive Auswirkung auf die Aufgabenleistung hat.<br><br> Es wurde daher die ${CHOICES.task_choice_de} für dich gewählt.<br><br>
Zum Weitermachen drücke bitte eine beliebige Taste. </span>`,
            align: "left",
            colour: "black",
            fontsize: 30,
            lineheight: 1.5,
