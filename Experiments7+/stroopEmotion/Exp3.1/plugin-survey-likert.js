var jsPsychSurveyLikert = (function (jspsych) {
    ...
    class SurveyLikertPlugin {
        ...
        trial(display_element, trial) {
            ...
            html +=
                ".jspsych-survey-likert-statement { display:block; font-size: 32px; padding-top: 20px; margin-bottom:-30px; }" +
                ".jspsych-survey-likert-opts { list-style:none; width:" +
                w +
                "; margin:auto; padding:0 0 35px; display:block; font-size: 50px; line-height:1.5em; }" +
                //".jspsych-survey-likert-opt-label { line-height: 1.5em; color: #444; }" +
                //".jspsych-survey-likert-opts:before { content: ''; position:relative; top:11px; /*left:9.5%;*/ display:block; background-color:#efefef; height:2px; width:100%; }" +
                ".jspsych-survey-likert-opts:last-of-type { border-bottom: 0; }" +
                ".jspsych-survey-likert-opts li { display:inline-block; /*width:19%;*/ text-align:center; vertical-align: top; }" +
                ".jspsych-survey-likert-opts li input[type=radio] { display:block; position:relative; height:25px; width:25px;top:95px; left:43%; margin-left:-6px; }";
            html += "</style>";
            // show preamble text
