...
// prettier-ignore
const trials = [
    { audio: audio_files[0], visual: visual_words[2], aff_neg: "aff", direction: "left",  corrResp: prms.respKeys[0]},
    { audio: audio_files[1], visual: visual_words[2], aff_neg: "neg", direction: "left",  corrResp: prms.respKeys[1]},
    { audio: audio_files[0], visual: visual_words[3], aff_neg: "aff", direction: "right", corrResp: prms.respKeys[1]},
    { audio: audio_files[1], visual: visual_words[3], aff_neg: "neg", direction: "right", corrResp: prms.respKeys[0]},
    { audio: audio_files[2], visual: visual_words[0], aff_neg: "aff", direction: "left",  corrResp: prms.respKeys[0]},
    { audio: audio_files[2], visual: visual_words[1], aff_neg: "neg", direction: "left",  corrResp: prms.respKeys[1]},
    { audio: audio_files[3], visual: visual_words[0], aff_neg: "aff", direction: "right", corrResp: prms.respKeys[1]},
    { audio: audio_files[3], visual: visual_words[1], aff_neg: "neg", direction: "right", corrResp: prms.respKeys[0]}
];
