    ...
    class SurveyLikertPlugin {
        ...
        trial(display_element, trial) {
            ...
            html +=
                ...
                w +
                "; margin:auto; padding:0 0 35px; display:block; font-size: 36px; line-height:1.1em; }" +
            ...
            for (var i = 0; i < trial.questions.length; i++) {
                ...
                for (var j = 0; j < question.labels.length; j++) {
                    options_string +=
                        '<li style="width:' +
                        width +
                        '%"><label class="jspsych-survey-likert-opt-label"><input style="transform: scale(2); "type="radio" name="Q' +
                        question_order[i] +
                        '" value="' +
                        j +
                        '"';
            ...
            // add submit button
            html +=
                '<input type="submit" style="font-size: 40px" id="jspsych-survey-likert-next" class="jspsych-survey-likert jspsych-btn" value="' +
                trial.button_label +
                '"></input>';
            html += "</form>";
            ...
            display_element.querySelector("#jspsych-survey-likert-form").addEventListener("submit", (e) => {
                ...
                if (trial_data.response.effort === "" || trial_data.response.effort === "") {
                    // message?
                } else {
