...
const WELCOME_INSTRUCTIONS = {
    ...
    stimulus: generate_formatted_html({
        text: `Willkommen zu unserem Experiment:<br><br>
           ...
           Du wirst nach dem Experiment auf Prolific zurückgeleitet.
...
const PROLIFIC = {
    ...
    stimulus: generate_formatted_html({
       ...
       https://app.prolific.com/submissions/complete?cc=C1E16MJR<br><br>
    ...
    on_finish: function () {
        window.location.replace("https://app.prolific.com/submissions/complete?cc=C1E16MJR");
    },
};
