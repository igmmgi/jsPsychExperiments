...
if ([1, 3].includes(VERSION)) {
    ...
    PRMS.letterTaskKeys = PRMS.respKeysRH; // NEWIAN e.g., vowel vs. consonant
} else if ([2, 4].includes(VERSION)) {
    PRMS.colourTaskKeys = PRMS.respKeysRH; // e.g., more red vs. more blue
    PRMS.letterTaskKeys = PRMS.respKeysLH; // NEWIAN e.g., vowel vs. consonant
}
...
const VP_CODE_INSTRUCTIONS = {
    ...
    stimulus: generate_formatted_html({
        text: `Super, du bist am Ende des Experiments!
               ...
               <br><br>Drücke die Leertaste, um das Experiment abzuschließen!`,
        align: 'left',
        fontsize: 30,
        width: '1200px',
        lineheight: 1.5,
