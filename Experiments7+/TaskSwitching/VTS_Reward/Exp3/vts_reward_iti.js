    ...
    on_finish: function () {
        if (PRMS.cBlk >= 8) {
            window.location.assign(
                "https://uni-tuebingen.sona-systems.com/webstudy_credit.aspx?experiment_id=291&credit_token=03f6a3ce15464a9d9775893474da37b6&survey_code=" +
...
const PRMS = {
    ...
    iti: [300, 1100], // duration of the inter-trial-interval
    feedbackDur: [0, 0, 1000], // duration of the reward screen
    rewardDur: 800, // duration of the reward screen
...
// prettier-ignore
const TRIAL_TABLE = [
  { trial_type: 1, free_forced: 'free',   forced_task: 'na',     iti: PRMS.iti[0] },
  { trial_type: 2, free_forced: 'free',   forced_task: 'na',     iti: PRMS.iti[0] },
  { trial_type: 3, free_forced: 'forced', forced_task: 'letter', iti: PRMS.iti[0] },
  { trial_type: 4, free_forced: 'forced', forced_task: 'colour', iti: PRMS.iti[0] },
  { trial_type: 5, free_forced: 'free',   forced_task: 'na',     iti: PRMS.iti[1] },
  { trial_type: 6, free_forced: 'free',   forced_task: 'na',     iti: PRMS.iti[1] },
  { trial_type: 7, free_forced: 'forced', forced_task: 'letter', iti: PRMS.iti[1] },
  { trial_type: 8, free_forced: 'forced', forced_task: 'colour', iti: PRMS.iti[1] },
];
