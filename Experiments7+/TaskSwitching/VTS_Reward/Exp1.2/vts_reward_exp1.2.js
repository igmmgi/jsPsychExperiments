...
// In correct trials, 70% get reward, 30% no reward
...
// Feedback screens
//  if error, no points
//  if correct in low-efficacy blocks (70 % random reward)
  ...
  on_finish: function () {
    if (PRMS.cBlk >= 11) {
      window.location.assign(
        "https://uni-tuebingen.sona-systems.com/webstudy_credit.aspx?experiment_id=361&credit_token=4493381670df4cd5bf29642a197075eb&survey_code=" +
        ...
        if (PRMS.cBlk === (PRMS.nBlks + 3) / 2) {
            trial.stimulus = generate_formatted_html({
                text: `*** ACHTUNG: NEUE INSTRUKTIONEN ***<br><br>
                       ZUFALLSBELOHNUNG: In diesem Teil des Experimentes, erhältst du zufällig 
                       eine Belohnung, wenn die Aufgabe korrekt bearbeitet wurde (d.h., unabhängig davon wie schnell du die Aufgabe bearbeitest).<br><br>
                       Drücke eine beliebige Taste, um fortzufahren`,
                align: "left",
                fontsize: 30,
                width: "1200px",
            ...
            trial.stimulus = generate_formatted_html({
                text: `ZUFALLSBELOHNUNG: In diesem Teil des Experimentes, erhältst du zufällig 
                       eine Belohnung, wenn die Aufgabe korrekt bearbeitet wurde (d.h., unabhängig davon wie schnell du die Aufgabe bearbeitest).<br><br>
                       Drücke eine beliebige Taste, um fortzufahren`,
                align: "left",
                fontsize: 30,
