    ...
    on_finish: function () {
        if (PRMS.count_block >= 12) {
            window.location.assign(
                "https://uni-tuebingen.sona-systems.com/webstudy_credit.aspx?experiment_id=552&credit_token=6107a2c4720e47d791a174c0010a99fc&survey_code=" +
...
const PRMS = {
    ...
    key_mapping: {},
    slider_prompt:
        "Wie schwierig war es im vorherigen Durchgang, schnell und genau zu reagieren?",
