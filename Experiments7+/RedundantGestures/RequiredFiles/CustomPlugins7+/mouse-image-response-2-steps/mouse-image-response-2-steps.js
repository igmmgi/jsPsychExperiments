...
var jsPsychMouseImageResponse2steps = (function(jspsych) {
    'use strict';

    const info = {
        name: 'mouse-image-response-2-steps',
        parameters: {
            func_args: {
    ...
    class MouseImageResponse2steps {
        constructor(jsPsych) {
            ...
            const draw = () => {
                ...
                if (draw_fixation) {
                    ...
                    this.jsPsych.pluginAPI.setTimeout(function() {
                        ...
                        draw_response_image = trial.draw_response_boxes_image[3];
    ...
    MouseImageResponse2steps.info = info;
    return MouseImageResponse2steps;
})(jsPsychModule);
