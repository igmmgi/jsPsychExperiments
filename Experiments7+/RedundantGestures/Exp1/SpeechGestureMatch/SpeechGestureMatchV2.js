...
const POLARITY = ["affirmation", "negation", "affirmation", "negation", 
                  "affirmation", "negation", "affirmation", "negation", 
				  "affirmation", "negation", "affirmation", "negation",
				  "affirmation", "negation", "affirmation", "negation"];
				  
const MATCHING = ["match", "mismatch", "match", "mismatch",
                  "mismatch", "match", "mismatch", "match",
                  "match", "mismatch", "match", "mismatch",
                  "mismatch", "match", "mismatch", "match"];

const MODALITY_A = ["speech", "speech", "speech", "speech", 
                    "speech", "speech", "speech", "speech",
                    "speech", "speech", "speech", "speech",
                    "speech", "speech", "speech", "speech"];
					
const MODALITY_B = ["gesture", "gesture", "gesture", "gesture",
                    "gesture", "gesture", "gesture", "gesture",
					"gesture", "gesture", "gesture", "gesture",
					"gesture", "gesture", "gesture", "gesture"];
				  
const VERBAL_A = ["yes", "no", "yes", "no",
                  "yes", "no", "yes", "no",
				  "yes", "no", "yes", "no",
				  "yes", "no", "yes", "no"];
				  
const VERBAL_B = ["yes", "yes", "yes", "yes",
                  "no", "no", "no", "no",
				  "yes", "yes", "yes", "yes",
				  "no", "no", "no", "no"];
				
const GESTURE_A = ["ThumbUp", "ThumbUp", "ThumbUp", "ThumbUp",
                   "ThumbDown", "ThumbDown", "ThumbDown", "ThumbDown",
                   "HeadNod", "HeadNod", "HeadNod", "HeadNod",
                   "HeadShake", "HeadShake", "HeadShake", "HeadShake"]; 

const GESTURE_B = ["ThumbUp", "ThumbDown", "ThumbUp", "ThumbDown", 
                   "ThumbUp", "ThumbDown", "ThumbUp", "ThumbDown",
                   "HeadNod", "HeadShake", "HeadNod", "HeadShake",
				   "HeadNod", "HeadShake", "HeadNod", "HeadShake"];
                   
const SPEAKER = ["female", "female", "male", "male",
