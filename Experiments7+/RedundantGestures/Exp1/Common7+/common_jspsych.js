...
function welcome_message(language = "de_sie", text = "") {
    const message = {
    ...
    if (text !== "") {
        ...
        message.stimulus = "<p>Willkommen! Falls Sie im Moment den Safari-Browser nutzen, bitten wir Sie zwecks Vermeidung</p>" +
		                   "<p>technischer Schwierigkeiten zu einem anderen Browser zu wechseln (z.B. Firefox oder Chrome).</p>" +
						   "<p>Vielen Dank! Drücken Sie eine beliebige Taste, um fortzufahren.</p>";
...
function end_message(language = "de_sie", text = "") {
    const message = {
        type: jsPsychHtmlKeyboardResponse,
        stimulus: "",
    };
...
function resize_browser(language = "de_sie", message = "") {
    const resize = {
        type: jsPsychResize,
        stimulus: "",
        button_label: "",
    ...
    if (message !== "") {
        ...
        resize.prompt =
            "<p>Klicken Sie auf die untere rechte Ecke und ziehen Sie, bis der Kasten etwa die gleiche Breite wie eine Bankkarte hat.</p>";
...
function fullscreen(on, language = "de") {
    if (language === "de") {
        return {
            ...
            fullscreen_mode: on,
            message: "<p>Das Experiment wechselt in den Vollbildmodus, sobald Sie die Schaltfläche ‚Weiter‘ drücken.</p>",
            button_label: "Weiter",
        };
    } else if (language === "en") {
        return {
