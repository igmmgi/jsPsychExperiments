...
const FLANKER = {
    ...
    on_start: function (trial) {
        ...
        let ratio_target = trial.data.ratio_target === "easy" ? PRMS.ratioTargetEasy : PRMS.ratioTargetHard;
        ...
        let ratio_distractor =
            trial.data.ratio_distractor === "easy" ? PRMS.ratioDistractorEasy : PRMS.ratioDistractorHard;
...
// prettier-ignore
const TRIAL_TABLE = [
  { ratio_target: "easy", ratio_distractor: "easy", distractor: PRMS.target[0], target: PRMS.target[0], compatibility: "comp",   correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[0])] },
  { ratio_target: "easy", ratio_distractor: "easy", distractor: PRMS.target[0], target: PRMS.target[1], compatibility: "incomp", correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[1])] },
  { ratio_target: "easy", ratio_distractor: "easy", distractor: PRMS.target[1], target: PRMS.target[0], compatibility: "incomp", correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[0])] },
  { ratio_target: "easy", ratio_distractor: "easy", distractor: PRMS.target[1], target: PRMS.target[1], compatibility: "comp",   correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[1])] },
  { ratio_target: "hard", ratio_distractor: "easy", distractor: PRMS.target[0], target: PRMS.target[0], compatibility: 'comp',   correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[0])] },
  { ratio_target: "hard", ratio_distractor: "easy", distractor: PRMS.target[0], target: PRMS.target[1], compatibility: 'incomp', correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[1])] },
  { ratio_target: "hard", ratio_distractor: "easy", distractor: PRMS.target[1], target: PRMS.target[0], compatibility: 'incomp', correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[0])] },
  { ratio_target: "hard", ratio_distractor: "easy", distractor: PRMS.target[1], target: PRMS.target[1], compatibility: 'comp',   correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[1])] },
  { ratio_target: "easy", ratio_distractor: "hard", distractor: PRMS.target[0], target: PRMS.target[0], compatibility: "comp",   correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[0])] },
  { ratio_target: "easy", ratio_distractor: "hard", distractor: PRMS.target[0], target: PRMS.target[1], compatibility: "incomp", correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[1])] },
  { ratio_target: "easy", ratio_distractor: "hard", distractor: PRMS.target[1], target: PRMS.target[0], compatibility: "incomp", correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[0])] },
  { ratio_target: "easy", ratio_distractor: "hard", distractor: PRMS.target[1], target: PRMS.target[1], compatibility: "comp",   correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[1])] },
  { ratio_target: "hard", ratio_distractor: "hard", distractor: PRMS.target[0], target: PRMS.target[0], compatibility: 'comp',   correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[0])] },
  { ratio_target: "hard", ratio_distractor: "hard", distractor: PRMS.target[0], target: PRMS.target[1], compatibility: 'incomp', correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[1])] },
  { ratio_target: "hard", ratio_distractor: "hard", distractor: PRMS.target[1], target: PRMS.target[0], compatibility: 'incomp', correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[0])] },
  { ratio_target: "hard", ratio_distractor: "hard", distractor: PRMS.target[1], target: PRMS.target[1], compatibility: 'comp',   correct_key: PRMS.respKeys[PRMS.target.indexOf(PRMS.target[1])] },
];
