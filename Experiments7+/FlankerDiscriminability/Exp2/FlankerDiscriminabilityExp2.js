// Flanker Task with manipulation of flanker discrimanibility
    ...
    on_finish: function () {
        if (PRMS.cBlk >= 12) {
            window.location.assign(
                "https://fernuni-hagen.sona-systems.com/webstudy_credit.aspx?experiment_id=226&credit_token=d53cf55db3e642a19363c87f33c80593&survey_code=" +
...
const PRMS = {
    ...
    ratioEasy: [5, 95], // should sum to 100!
...
const FLANKER = {
    ...
    on_start: function (trial) {
        ...
        let ratio_target = PRMS.ratioTarget;
        ...
        let ratio_distractor = trial.data.ratio === "easy" ? PRMS.ratioEasy : PRMS.ratioHard;
