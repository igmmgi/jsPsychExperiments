...
function genExpSeq() {
  ...
  let blk_type;
  if (VERSION === 1) {
    blk_type = repeatArray(['HiPri_LowBack'], PRMS.nBlks / 2).concat(repeatArray(['LowPri_HighBack'], PRMS.nBlks / 2));
  } else if (VERSION === 2) {
    blk_type = repeatArray(['LowPri_HighBack'], PRMS.nBlks / 2).concat(repeatArray(['HiPri_LowBack'], PRMS.nBlks / 2));
  }
