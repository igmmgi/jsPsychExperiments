jsPsych.plugins['static-canvas-keyboard-multiple-response-visual-sound'] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
      ...
      let source = audio_context.createBufferSource(); source.buffer =
      jsPsych.pluginAPI.getAudioBuffer(trial.sound_stimulus);
      source.connect(audio_context.destination);

      // play audio
      console.log(audio_context);
      startTime = audio_context.currentTime;
      source.start(startTime + (trial.stimulus_onset[1]/1000));
